...
from dataset.data_loader2 import data_loaders
...
def main():
    ...
    parser.add_argument('--wandb', default=True, help='test')
    ...
    train_WSDM_loader, val_WSDM_loader = WSDM_dataloaders["train"], WSDM_dataloaders["valid"]
    ...
    if args.test:
        ...
        for epoch in range(args.nb_epoch):
            ...
            train_epoch(train_WSDM_loader, model, optimizer, epoch, args)
            '''
            accu_new = validate_epoch(val_WSDM_dataloader, model, args)
